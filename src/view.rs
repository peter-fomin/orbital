...
fn converged_label() -> impl Widget<LambertSolver> {
    let converged_label = Label::new(|ls: &LambertSolver, _env: &Env| format!("Status: {}", 
        match ls.status {
            ...
            LambertSolverStatus::CollinearVectors => "cannot determine orbit, collinear radius-vectors",
            LambertSolverStatus::MultiRevolution => "time-of-flight is too big, multi-revolution is not supported",
